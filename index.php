...
<body class="flex items-center justify-center h-screen bg-Secondary">
  <div class="bg-Primary w-[420px] border-2 rounded-2xl py-6 px-8 shadow-2xl text-white">
    ...
    <div class="w-full my-5 text-lg">
        <form action="index.php" method="post">
            ...
            <input class="w-full h-[45px] bg-white text-Primary rounded-3xl font-bold mt-6 cursor-pointer hover:bg-gray-200" type="submit" name="login" value="Login">
        </form>
    </div>
  </div>
</body>
