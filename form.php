...
<body class="flex items-center justify-center min-h-screen bg-Secondary p-6">
    <div class=" bg-Primary w-lg border-2 rounded-2xl py-6 px-8 shadow-2xl text-white">
        ...
        <div class="w-full my-5 text-lg">
            <form action="cv.php" method="post">
                ...
                <input class="w-full h-[45px] bg-white text-Primary rounded-3xl font-bold mt-6 cursor-pointer hover:bg-gray-200" type="submit" name="submit" value="Submit">
            </form>
        </div>
        
        <form method="post">
            <button type="submit" name="logout" class="w-full h-[45px] bg-white text-Primary rounded-3xl font-bold mt-6 cursor-pointer hover:bg-gray-200">
                Logout
            </button>
        </form>
    </div>
